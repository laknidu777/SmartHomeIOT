...
void startAPMode() {
    WiFi.softAP("LIGHT_Config");  // Open Access Point (NO PASSWORD)
    Serial.println("AP Mode Started! Connect to 'ESP32_Config' and go to 192.168.4.1");
